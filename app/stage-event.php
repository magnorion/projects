<html>
	...
	<body>
		...
		<div id="body-site">
			...
			<div id="container">
				<div id="data-panel">
					<div id="post-add-placement">
						<div id="post-add">
							<ul>
								<li><a href="user-profile.php"><i class="fa fa-globe"></i> Title Event</a></li>
								<li><a href="new-post.php"> <i class="fa fa-plus"></i> Ação</a></li>
								<li><a href="user-profile.php"> <i class="fa fa-users"></i> Players</a></li>
							</ul>
						</div>
					</div>
